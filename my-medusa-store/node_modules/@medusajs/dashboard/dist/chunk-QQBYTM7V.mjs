          ...
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-UOBVAKB4.mjs")
                    },
                    {
                      path: "import",
                ...
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-E7ERPVAU.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-E7ERPVAU.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-ASWHWQSN.mjs")
                        },
                        {
                          path: "edit-variant",
                        ...
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-U6AOIQQE.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-2IAG22YO.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-STNOOKBY.mjs")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-6HEMSWGD.mjs")
                        },
                        {
                          path: "prices",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-26I34P37.mjs")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-7DZOJFLW.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./promotion-detail-JXJHHW7M.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./campaign-detail-E7BOO6OH.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-DOCR5HAJ.mjs")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-2LTQLJF3.mjs")
                    }
                  ]
                },
                {
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-ARMD7ECL.mjs")
            },
            {
              path: "/invite",
